<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Association.aspx.cs" Inherits="GoDurban.PL.Association" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
   ...
   <%-- <script src="../../Scripts1/buttons.html5.min.js"></script>--%>
    ...
    <h4>Create Association-Bank</h4>
    <div id="accordion" role="tablist" aria-multiselectable="true">
        <div class="panel panel-default" style="width: 100%">
            <div class="panel-heading" role="tab" id="headingOne">
                <h4 class="panel-title">
                    <a id="first" data-toggle="collapse" data-parent="#accordion" href="#collapseOne" aria-expanded="false" aria-controls="collapseOne"><strong>
                        <asp:Label ID="Label2" runat="server" Text="Association-Bank"></asp:Label>
                    </strong>
                    </a>
                </h4>
            </div>
            ...
            <div id="collapseOne" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne" style="padding: 1%">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <asp:TextBox ID="txtAssociation" placeholder="Association" runat="server" class="form-control limited" Height="34px" Width="250px" MaxLength="100" onfocusout="ValidateAssociation(this);"></asp:TextBox>
                    </div>
                </div>
                <div class="row">
