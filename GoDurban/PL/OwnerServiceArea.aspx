<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="OwnerServiceArea.aspx.cs" Inherits="GoDurban.PL.OwnerServiceArea" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
   ...
   <%-- <script src="../../Scripts1/buttons.html5.min.js"></script>--%>
    ...
    <h4>Link Owner With Service Area</h4>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="side-by-side clearfix">
                            <asp:DropDownList ID="ddlOwner" runat="server" class="chosen-select" Width="300px" Height="34px" AutoPostBack="true" AppendDataBoundItems="True" OnSelectedIndexChanged="ddlOwner_SelectedIndexChanged">
        ...
        <div class="panel panel-default">
            <div class="panel-heading" role="tab" id="headingTwo">
                <h4 class="panel-title">
                    <a id="Second" data-toggle="collapse" data-parent="#accordion2" href="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo"><strong>
                        <asp:Label ID="Label3" runat="server" Text="All Service Areas"></asp:Label>
                    </strong>
                    </a>
                </h4>
            </div>
            <div id="collapseTwo" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingTwo" style="padding: 1%">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <asp:GridView ID="gvServiceArea" runat="server" Width="100%" CssClass="gvdatatable table table-striped table-bordered"
                            ...
                            DataKeyNames="AssociationServiceAreaID">
                            <Columns>
                                ...
                                <asp:BoundField DataField="AssociationServiceAreaID" HeaderText="Id" SortExpression="Id" Visible="false"></asp:BoundField>
                ...
                <div class="form-group pull-left">
                    ...
                    <asp:Label ID="lblCheck" runat="server" Text="Please Select Atleast One Record!" ForeColor="Red" Visible="false"></asp:Label>
                </div>
    ...
    <div id="accordion3" role="tablist" aria-multiselectable="true" runat="server" style="display: none">
        <div class="panel panel-default">
            ...
            <div id="collapseThird" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingThird" style="padding: 1%">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <asp:GridView ID="gvServiceAreaUnlink" runat="server" Width="100%" CssClass="gvdatatable table table-striped table-bordered"
                            ...
                            DataKeyNames="OwnerServiceAreaID">
                            <Columns>
                                ...
                                <asp:BoundField DataField="OwnerServiceAreaID" HeaderText="Id" Visible="false"></asp:BoundField>
                ...
                <div class="form-group pull-left">
                    <asp:Button ID="Button1" runat="server" type="button" Text="Unlink" Height="34px" Width="70px" class="btn btn-primary form-control" OnClientClick="return confirm('Are you sure you want to unlink selected records?')" OnClick="btnUnlink_Click" />
                    <asp:Label ID="lblCheckUnlink" runat="server" Text="Please Select Atleast One Record!" ForeColor="Red" Visible="false"></asp:Label>
                </div>
                <span class="counter pull-left"></span>
                <br />
                <br />
