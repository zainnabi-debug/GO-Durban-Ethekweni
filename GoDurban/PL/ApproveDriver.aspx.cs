...
{
    public partial class ApproveDriver : System.Web.UI.Page
    {
        ...
        {
            driID = Convert.ToInt32(Request.QueryString["DriverID"].ToString());
        ...
        protected void btnAdd_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                else if (ValidateDriverEdit() && temp.Contains("Update"))
                {
                    ...
                    if ((ddlStatus.SelectedItem.Text == "Active") || (ddlStatus.SelectedItem.Text == "Approved"))
                    {
                        TBL.StatusID = Convert.ToInt16(ddlStatus.SelectedValue);
                    }
                    else if ((ddlStatus.SelectedItem.Text == "Inactive") || (ddlStatus.SelectedItem.Text == "Cancelled") || (ddlStatus.SelectedItem.Text == "Pending"))
                    ...
                    var id = db.tbl_Driver.ToList().FirstOrDefault(x => x.DriverID == driID);
                    if ((d == null) || (id.IDNo == txtIDNo.Text.Trim()))
                    {
                        if (ddlStatus.SelectedItem.Text == "Approved")
                        {
                            ...
                            divDriverr.Style.Add("display", "inline");
                            divDriverrr.Style.Add("display", "inline");
                            ...
                            divUploadDocuments.Style.Add("display", "none");
                            divDriver.Style.Add("display", "inline");
        ...
        private void LoadData()
        {
            ...
            gvDriver.DataSource = list.ToList();
            gvDriver.DataBind();
        }
        ...
        {
            Response.Redirect("~/PL/ApproveDriver.aspx?DriverID=" + driID);
        }
        ...
        public void SendSmsEdit()
        {
            try
            {
                if ((ddlOwner.SelectedValue != "0") && (ddlStatus.SelectedItem.Text == "Approved"))
                {
                    ...
                    req.Parameters.Parameter2.Value = txtIDNo.Text;

                    req.Parameters.Parameter3 = new Parameter3_T();
                    req.Parameters.Parameter3.Name = "Parameter3";
                    req.Parameters.Parameter3.Value = driverno;
        ...
        public void CreatePDF()
        {
            ...
            document.Add(new Paragraph("Approve Driver", titleFont));
            ...
            Response.AddHeader("Content-Disposition", "attachment; filename=ApproveDriver.pdf");
        ...
        {
            var temp = db.tbl_Driver.ToList().FirstOrDefault(x => x.DriverID == driID);
            ...
            if (temp != null)
            {
                ...
                var data2 = db.tbl_Driver.ToList().FirstOrDefault(x => x.DriverID == Convert.ToInt16(driID));
