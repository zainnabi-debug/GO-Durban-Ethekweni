...
{
    public partial class ApproveRegionalLeadership : System.Web.UI.Page
    {
        ...
        {
            regLID = Convert.ToInt32(Request.QueryString["RegionalLeaderID"].ToString());
        ...
        //                join c in db.tbl_Region on a.RegionID equals c.RegionID
        ...
        //                    f.ReasonDescription
        //                });
        //    gvRegionalLeader.DataSource = list.ToList();
        ...
        private void LoadData()
        {
            var list = (from a in db.tbl_RegionalLeadership
                        ...
                        where a.RegionalLeaderID == regLID
                ...
                if (ValidateRegionalLeadership())
                {
                    ...
                    else if (temp.Contains("Update"))
                    {
                        ...
                        //else
                        {
                            ...
                            var id = db.tbl_RegionalLeadership.ToList().FirstOrDefault(x => x.RegionalLeaderID == regLID);

                            var p = db.tbl_RegionalLeadership.ToList().Find(x => x.Passport == txtPassport.Text.ToString());

                            var pp = db.tbl_RegionalLeadership.ToList().FirstOrDefault(x => x.RegionalLeaderID == regLID);
        ...
        public void CreatePDF()
        {
            ...
            document.Add(new Paragraph("Approve Regional Leadership", titleFont));
            ...
            Response.AddHeader("Content-Disposition", "attachment; filename=ApproveRegionalLeadership.pdf");
        ...
        {
            var temp = db.tbl_RegionalLeadership.ToList().FirstOrDefault(x => x.RegionalLeaderID == regLID);
            ...
            if (temp != null)
            {
                ...
                Session["RegionalLeaderID"] = regLID;
                txtName.Text = temp.Name;
                txtSurname.Text = temp.Surname;
