<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="ResetPassword.aspx.cs" Inherits="GoDurban.PL.ResetPassword" %>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div id="login_form" runat="server" action="#" method="post" role="form" style="display: block;">
                                    ...
                                    <div class="form-group">
                                        <asp:TextBox ID="txtNewPassword" runat="server" PlaceHolder="New Password" CssClass="form-control" Height="34px" TextMode="Password"></asp:TextBox>
                                        <label><span style="color: red">*</span></label>
                                    </div>
                                    <div class="form-group">
                                        <asp:TextBox ID="txtConfirmPassword" runat="server" PlaceHolder="Confirm Password" CssClass="form-control" TextMode="Password" Height="34px"></asp:TextBox>
                                        ...
                                        <asp:CompareValidator ID="CompareValidator1" runat="server"
                                            ...
                                            ErrorMessage="New password must match confirm password"
                                    ...
                                    <div class="form-group pull-left">
                                        <asp:Button ID="btnAdd" Width="150px" class="form-control btn btn-register" runat="server" Text="Reset" OnClick="btnSubmit_Click" />
