<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ApproveOwner.aspx.cs" Inherits="GoDurban.PL.ApproveOwner" %>
        ...
        <div class="panel panel-default" style="width: 100%">
            ...
            <div id="collapseOne" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne" style="padding: 1%">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <asp:TextBox ID="txtCO" placeholder="Company Name" runat="server" Enabled="false" CssClass="form-control limited" Height="34px" Width="250px"></asp:TextBox>
                    </div>
                </div>
                <div class="row">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <asp:TextBox ID="txtCity" placeholder="City" runat="server" Enabled="false" CssClass="form-control limited" Height="34px" MaxLength="50" Width="250px" onkeyup="CheckName(this);" onkeydown="CheckName(this);" onfocusout="ValidateCity(this);"></asp:TextBox>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <asp:GridView ID="gvOwner" runat="server" Width="100%" CssClass="gvdatatable table table-striped table-bordered"
                            ...
                            OnPreRender="gvOwner_PreRender" OnRowCommand="gvOwner_RowCommand">
                            <Columns>
                                <asp:TemplateField>
                                    <ItemTemplate>
