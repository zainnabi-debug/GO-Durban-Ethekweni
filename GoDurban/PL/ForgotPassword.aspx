<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="ForgotPassword.aspx.cs" Inherits="GoDurban.PL.ForgotPassword" %>
                            ...
                            <div class="col-lg-12">
                                <div id="login_form" runat="server" action="#" method="post" role="form" style="display: block;">
                                    ...
                                    <div class="form-group pull-left">
                                        <asp:Button ID="btnAdd" Width="150px" class="form-control btn btn-register" runat="server" Text="SUBMIT" OnClick="btnSubmit_Click" />
                                    </div>
                                    <span class="counter pull-left"></span>

                                    <div class="form-group pull-right">
                                        <asp:HyperLink ID="hlIndex" runat="server" Width="150px" class="form-control btn btn-register" NavigateUrl="../Index.aspx">Back To Login</asp:HyperLink>
                                    </div>
