<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ApproveRegionalLeadership.aspx.cs" Inherits="GoDurban.PL.ApproveRegionalLeadership" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
   ...
   <%-- <script src="../../Scripts1/buttons.html5.min.js"></script>--%>
    ...
    <h4>Approve Regional Leadership</h4>
        ...
        <div class="panel panel-default" style="width: 100%">
            ...
            <div id="collapseOne" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne" style="padding: 1%">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <asp:TextBox ID="txtName" placeholder="Name" runat="server" Enabled="false" CssClass="form-control limited" MaxLength="100" Height="34px" Width="250px" onkeyup="CheckName(this);" onkeydown="CheckName(this);" onfocusout="ValidateName(this);"></asp:TextBox>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="side-by-side clearfix">
                            <asp:DropDownList ID="ddlRegion" runat="server" Enabled="false" AppendDataBoundItems="True" CssClass="chosen-select" Width="250px" Height="34px" OnSelectedIndexChanged="ddlRegion_SelectedIndexChanged">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <asp:TextBox ID="txtSuburb" placeholder="Suburb" runat="server" Enabled="false" CssClass="form-control limited" MaxLength="50" Height="34px" Width="250px" onkeyup="CheckName(this);" onkeydown="CheckName(this);" onfocusout="ValidateSuburb(this);"></asp:TextBox>
                    </div>
                </div>
                <div class="row">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <asp:GridView ID="gvRegionalLeader" Width="100%" CssClass="gvdatatable table table-striped table-bordered"
                            ...
                            OnPreRender="gvRegionalLeader_PreRender" OnRowCommand="gvRegionalLeader_RowCommand">
