<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ApproveAssociation.aspx.cs" Inherits="GoDurban.PL.ApproveAssociation" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
   ...
   <%-- <script src="../../Scripts1/buttons.html5.min.js"></script>--%>
    ...
    <script type="text/javascript">
        ...
        function ValidateAssociation(txtAssociation) {

            var ass = txtAssociation.value;
            if (ass.length == "") {
                txtAssociation.style.border = '1px solid red';
                txtAssociation.value = null;
                return false;
            }
            else {
                txtAssociation.style.border = '';
            }
        }
    ...
    <h4>Approve Association-Bank</h4>
    <div id="divAssociation" role="tablist" aria-multiselectable="true" runat="server" style="display: inline">
        <div class="panel panel-default" style="width: 100%">
            ...
            <div id="collapseOne" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne" style="padding: 1%">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <asp:TextBox ID="txtAssociation" placeholder="Association" runat="server" Enabled="false" CssClass="form-control limited" Height="34px" Width="250px" MaxLength="100" onfocusout="ValidateAssociation(this);"></asp:TextBox>
                    </div>
                </div>
                <div class="row">
            ...
            <div class="panel-heading" role="tab" id="headingTwo">
                <h4 class="panel-title">
                    <a id="Second" data-toggle="collapse" data-parent="#accordion2" href="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo"><strong>
                        <asp:Label ID="lblAddb" runat="server" Text="Association"></asp:Label>
                    </strong>
                    </a>
                </h4>
            </div>
