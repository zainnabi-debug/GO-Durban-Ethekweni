<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="PaymentRegion.aspx.cs" Inherits="GoDurban.PL.PaymentRegion" %>
            ...
            <div class="panel-heading" role="tab" id="headingOne">
                <h4 class="panel-title">
                    <a id="first" data-toggle="collapse" data-parent="#accordion" href="#collapseOne" aria-expanded="false" aria-controls="collapseOne"><strong>
                        <asp:Label ID="Label2" runat="server" Text="Payment-Region"></asp:Label>
                    </strong>
                    </a>
                </h4>
            </div>
            ...
            <div id="collapseOne" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne" style="padding: 1%">
                ...
                <div class="row" id="divExport" runat="server">
                    <div class="form-group pull-left">
                        <asp:Button ID="btnExportTo" runat="server" Text="Send to Staging Area" Height="34px" Width="160px" class="btn btn-primary form-control" OnClick="btnExportTo_Click" OnClientClick="initLoadHoldOn();"/>
                        <asp:Button ID="Button1" runat="server" Text="Export To Excel" Height="34px" Width="160px" class="btn btn-primary form-control" OnClick="Export_To_Excel" OnClientClick="Export_To_Excel();"/>
                        <asp:Label ID="lblSent" runat="server" Text="Record(s) sent!" ForeColor="Green" Visible="false"></asp:Label>
                    </div>
                </div>
