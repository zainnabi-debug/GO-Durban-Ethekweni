<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ServiceArea.aspx.cs" Inherits="GoDurban.PL.ServiceArea" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <h4>Create Service Area</h4>
    <div id="accordion" role="tablist" aria-multiselectable="true">
        <div class="panel panel-default" style="width: 100%">
            <div class="panel-heading" role="tab" id="headingOne">
                <h4 class="panel-title">
                    <a id="first" data-toggle="collapse" data-parent="#accordion" href="#collapseOne" aria-expanded="false" aria-controls="collapseOne">
                        <strong>
                            <asp:Label ID="Label2" runat="server" Text="Service Area "></asp:Label>
                        </strong>
                    </a>
                </h4>
            </div>
            ...
            <div id="collapseOne" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne" style="padding: 1%">
                ...
                <div class="row">
                    <div class="col-md-2">Enter Service Area:</div>
                    <div class="col-md-4">
                        <asp:TextBox ID="txtServiceArea" placeholder="Service Area" runat="server" class="form-control limited" Height="34px" Width="250px" MaxLength="100"></asp:TextBox>
                    </div>
                </div>
    ...
    <div id="accordion2" role="tablist" aria-multiselectable="true">
        <div class="panel panel-default">
            <div class="panel-heading" role="tab" id="headingTwo">
                <h4 class="panel-title">
                    <a id="Second" data-toggle="collapse" data-parent="#accordion2" href="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
                        <strong>
            ...
            <div id="collapseTwo" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingTwo" style="padding: 1%">
                <div class="row">
                    <div class="col-md-12">
                        <asp:GridView ID="gvServiceArea" Width="100%" CssClass="gvdatatable table table-striped table-bordered" runat="server"
                            OnPreRender="gvServiceArea_PreRender" AutoGenerateColumns="false" DataKeyNames="ServiceAreaID" OnRowCommand="gvServiceArea_RowCommand">
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="ServiceAreaID" HeaderText="ServiceAreaID" SortExpression="Id" HeaderStyle-CssClass="hidden" ItemStyle-CssClass="hidden"></asp:BoundField>
