<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ApproveAssociationLeadership.aspx.cs" Inherits="GoDurban.PL.ApproveAssociationLeadership" %>
   ...
   <%-- <script src="../../Scripts1/buttons.html5.min.js"></script>--%>
    ...
    <div id="divwarning" runat="server" style="display: none">
        <div class="alert alert-warning">
            <a href="#" class="close" data-dismiss="alert">&times;</a>
            <div>Association Leadership Exists!</div>
        </div>
    </div>
    ...
    <h4>Approve Association Leadership</h4>
        ...
        <div class="panel panel-default" style="width: 100%">
            ...
            <div id="collapseOne" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne" style="padding: 1%">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <asp:TextBox ID="txtName" placeholder="Name" runat="server" Enabled="false" CssClass="form-control limited" Height="34px" MaxLength="100" Width="250px" onkeyup="CheckName(this);" onkeydown="CheckName(this);" onfocusout="ValidateName(this);"></asp:TextBox>
                    </div>
                    <div class="col-md-2">Surname: <span style="color: red">*</span></div>
                    <div class="col-md-4">
                        <asp:TextBox ID="txtSurname" placeholder="Surname" runat="server" Enabled="false" CssClass="form-control limited" MaxLength="100" Height="34px" Width="250px" onkeyup="CheckName(this);" onkeydown="CheckName(this);" onfocusout="ValidateSurname(this);"></asp:TextBox>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-2">ID No.: <span id="spAsterik1" runat="server" style="color: red; display: inline">*</span></div>
                    <div class="col-md-4">
                        <asp:TextBox ID="txtIDNo" placeholder="ID No." runat="server" Enabled="false" CssClass="form-control limited" Height="34px" Width="250px" onkeypress="return isNumberKey(event)" onfocusout="ValidateIDNo(this);" MaxLength="13"></asp:TextBox>
                    </div>
                     <div class="col-md-2">Passport No.:  <span id="spAsterik" runat="server" style="color: red; display: none">*</span> <asp:CheckBox ID="chkPassport" runat="server" Enabled="false" AutoPostBack="true" CssClass="ChkBox" OnCheckedChanged="chkPassport_CheckedChanged" /> </div>
                    <div class="col-md-4">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <asp:TextBox ID="txtCellNo" placeholder="Cell No." runat="server" Enabled="false" CssClass="form-control limited" Height="34px" Width="250px" onkeypress="return isNumberKey(event)" onfocusout="ValidateCellNO(this);" MaxLength="10"></asp:TextBox>
                    </div>
                    <div class="col-md-2">Gender: <span style="color: red">*</span></div>
                    <div class="col-md-4">
                        <asp:DropDownList ID="ddlGender" runat="server" Enabled="false" AppendDataBoundItems="True" CssClass="form-control" Width="250px" Height="34px" onfocusout="ValidateGender(this);">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <asp:TextBox ID="txtOfficeNo" placeholder="Office No." runat="server" Enabled="false" CssClass="form-control limited" Height="34px" Width="250px" onkeypress="return isNumberKey(event)" onfocusout="ValidateOfficeNO(this);" MaxLength="10"></asp:TextBox>
                    </div>
                    <div class="col-md-2">Race: <span style="color: red">*</span></div>
                    <div class="col-md-4">
                        <asp:DropDownList ID="ddlRace" runat="server" Enabled="false" AppendDataBoundItems="True" CssClass="form-control" Width="250px" Height="34px" onfocusout="ValidateRace(this);">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <asp:TextBox ID="txtEmail" placeholder="Email" runat="server" Enabled="false" CssClass="form-control limited" MaxLength="50" Height="34px" Width="250px" onfocusout="ValidateBusinessEmail(this);" onkeyup="ValidateEmailID(this);"></asp:TextBox>
                    ...
                    <div class="col-md-2">Association: <span style="color: red">*</span></div>
                    <div class="col-md-4">
                        <div class="side-by-side clearfix">
                            <asp:DropDownList ID="ddlAssociation" runat="server" Enabled="false" AppendDataBoundItems="True" CssClass="chosen-select" Width="250px" Height="34px" OnSelectedIndexChanged="ddlAssociation_SelectedIndexChanged">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <asp:TextBox ID="txtStreetNo" placeholder="Street No. & Name" runat="server" Enabled="false" CssClass="form-control limited" MaxLength="100" Height="34px" Width="250px" onkeyup="CheckName1(this);" onkeydown="CheckName1(this);" onfocusout="ValidateStreetNoName(this);"></asp:TextBox>
                    </div>
                    <div class="col-md-2">Suburb: <span style="color: red">*</span></div>
                    <div class="col-md-4">
                        <asp:TextBox ID="txtSuburb" placeholder="Suburb" runat="server" Enabled="false" CssClass="form-control limited" Height="34px" MaxLength="50" Width="250px" onkeyup="CheckName(this);" onkeydown="CheckName(this);" onfocusout="ValidateSuburb(this);"></asp:TextBox>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-2">City: <span style="color: red">*</span></div>
                    <div class="col-md-4">
                        <asp:TextBox ID="txtCity" placeholder="City" runat="server" Enabled="false" CssClass="form-control limited" MaxLength="50" Height="34px" Width="250px" onkeyup="CheckName(this);" onkeydown="CheckName(this);" onfocusout="ValidateCity(this);"></asp:TextBox>
                    </div>
                    <div class="col-md-2">Code: <span style="color: red">*</span></div>
                    <div class="col-md-4">
                        <asp:TextBox ID="txtCode" placeholder="Code" runat="server" Enabled="false" CssClass="form-control limited" Height="34px" Width="250px" onkeypress="return isNumberKey(event)" MaxLength="4" onfocusout="ValidateCode(this);"></asp:TextBox>
                    </div>
                </div><br />
                <div class="row">
                    <div class="col-md-2">Status: <span style="color: red">*</span></div>
                    <div class="col-md-4">
                        <asp:DropDownList ID="ddlStatus" runat="server" AppendDataBoundItems="True" CssClass="form-control" Width="250px" Height="34px" AutoPostBack="true" onfocusout="ValidateStatus(this);" OnSelectedIndexChanged="ddlStatus_SelectedIndexChanged">
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <asp:GridView ID="gvAssociationLeadership" Width="100%" CssClass="gvdatatable table table-striped table-bordered"
                            runat="server" OnPreRender="gvAssociationLeadership_PreRender" AutoGenerateColumns="false" DataKeyNames="AssociationLeaderID" Font-Size="9"
                            OnRowCommand="gvAssociationLeadership_RowCommand">
