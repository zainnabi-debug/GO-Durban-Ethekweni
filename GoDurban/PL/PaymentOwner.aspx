<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="PaymentOwner.aspx.cs" Inherits="GoDurban.PL.PaymentOwner" %>
            ...
            <div class="panel-heading" role="tab" id="headingOne">
                <h4 class="panel-title">
                    <a id="first" data-toggle="collapse" data-parent="#accordion" href="#collapseOne" aria-expanded="false" aria-controls="collapseOne"><strong>
                        <asp:Label ID="Label2" runat="server" Text="Payment-Owner"></asp:Label>
                    </strong>
                    </a>
                </h4>
            </div>
                    ...
                    <div class="col-md-12">
                        ...
                        <asp:GridView ID="gvPayment" Width="100%" CssClass="gvdatatable table table-striped table-bordered" 
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="City" HeaderText="City" HeaderStyle-HorizontalAlign="right"/>
