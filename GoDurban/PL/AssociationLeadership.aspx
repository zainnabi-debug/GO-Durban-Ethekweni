<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AssociationLeadership.aspx.cs" Inherits="GoDurban.PL.AssociationLeadership" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
   ...
   <%-- <script src="../../Scripts1/buttons.html5.min.js"></script>--%>
    ...
    <h4>Create Association Leadership</h4>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="side-by-side clearfix">
                            <asp:DropDownList ID="ddlAssociation" runat="server" AppendDataBoundItems="True" class="chosen-select" Width="250px" Height="34px" OnSelectedIndexChanged="ddlAssociation_SelectedIndexChanged">
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <asp:GridView ID="gvAssociationLeadership" Width="100%" CssClass="gvdatatable table table-striped table-bordered"
                            ...
                            OnRowCommand="gvAssociationLeadership_RowCommand" OnRowDataBound="gvAssociationLeadership_RowDataBound">
