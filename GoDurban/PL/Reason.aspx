<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Reason.aspx.cs" Inherits="GoDurban.PL.Reason" %>
        ...
        <div class="panel panel-default" style="width: 100%">
            ...
            <div id="collapseOne" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne" style="padding: 1%">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <asp:TextBox ID="txtReason" placeholder="Reason" runat="server" class="form-control limited" Height="34px" Width="250px" onkeyup="CheckName(this);" onkeydown="CheckName(this);"></asp:TextBox>
                    </div>
                </div>
    ...
    <div id="accordion2" role="tablist" aria-multiselectable="true">
        <div class="panel panel-default">
            ...
            <div id="collapseTwo" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingTwo" style="padding: 1%">
                <div class="row">
                    <div class="col-md-12">
                        <asp:GridView ID="gvReason" Width="100%" CssClass="gvdatatable table table-striped table-bordered" 
                            runat="server" OnPreRender="gvReason_PreRender" AutoGenerateColumns="false" 
                            DataKeyNames="ReasonID" OnRowCommand="gvReason_RowCommand">
                            ...
                            <Columns>
                              ...
                              <%--  <asp:TemplateField>
                                ...
                                <asp:BoundField DataField="ReasonID" HeaderText="ReasonID" SortExpression="Id" HeaderStyle-CssClass="hidden" ItemStyle-CssClass="hidden"></asp:BoundField>
