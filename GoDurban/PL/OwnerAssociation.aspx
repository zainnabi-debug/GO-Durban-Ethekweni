<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="OwnerAssociation.aspx.cs" Inherits="GoDurban.PL.OwnerAssociation" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
   ...
   <%-- <script src="../../Scripts1/buttons.html5.min.js"></script>--%>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            $('#btnAdd').click(function () {
                var chkboxrowcount = $("#<%=gvAssociation.ClientID%> input[id*='chkRow']:checkbox:checked").size();
                if (chkboxrowcount == 0) {
    ...
    <h4>Link Owner With Association</h4>
    <div id="accordion" role="tablist" aria-multiselectable="true">
        <div class="panel panel-default" style="width: 100%">
            ...
            <div id="collapseOne" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne" style="padding: 1%">
                ...
                <div class="row">
                    <div class="col-md-2">Select Owner:</div>
                    <div class="col-md-4">
                        <div class="side-by-side clearfix">
                            <asp:DropDownList ID="ddlOwner" runat="server" class="chosen-select" Width="250px" Height="34px" AutoPostBack="true" AppendDataBoundItems="True" OnSelectedIndexChanged="ddlOwner_SelectedIndexChanged">
                            ...
                            <br />
                    <asp:Label ID="lblOwner" runat="server" Text="Select Owner!" ForeColor="Red" Visible="false"></asp:Label>
                        </div>
                    </div>
        ...
        <div class="panel panel-default">
            <div class="panel-heading" role="tab" id="headingTwo">
                <h4 class="panel-title">
                    <a id="Second" data-toggle="collapse" data-parent="#accordion2" href="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo"><strong>
                        <asp:Label ID="Label1" runat="server" Text="All Associations"></asp:Label>
                    </strong>
                    </a>
                </h4>
            </div>
            <div id="collapseTwo" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingTwo" style="padding: 1%">
              ...
              <%--  <div class="form-group pull-right">
                ...
                <div class="row">
                    <div class="col-md-12">
                            <asp:GridView ID="gvAssociation" runat="server" Width="100%" CssClass="gvdatatable table table-striped table-bordered"
                            EmptyDataText="No records found" AllowPaging="true" AllowSorting="true" AutoGenerateColumns="false"
                            OnPageIndexChanging="gvAssociation_PageIndexChanging" PagerStyle-Font-Size="Large"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="AssociationID" HeaderText="Id" Visible="false"></asp:BoundField>
                                <asp:BoundField DataField="AssociationName" HeaderText="Association"></asp:BoundField>
                            </Columns>
                ...
                <div class="form-group pull-left">
                    ...
                    <asp:Label ID="lblCheck" runat="server" Text="Please Select Atleast One Association!" ForeColor="Red" Visible="false"></asp:Label>
                </div>
        ...
        <div class="panel panel-default">
            <div class="panel-heading" role="tab" id="headingThird">
                <h4 class="panel-title">
                    <a id="Third" data-toggle="collapse" data-parent="#accordion3" href="#collapseThird" aria-expanded="false" aria-controls="collapseThird"><strong>
                        <asp:Label ID="Label3" runat="server" Text="Linked Associations"></asp:Label>
                    </strong>
                    </a>
                </h4>
            </div>
            <div id="collapseThird" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingThird" style="padding: 1%">
              ...
              <%--  <div class="form-group pull-right">
                ...
                <div class="row">
                    <div class="col-md-12">
                             <asp:GridView ID="gvAssociationUnlink" runat="server" Width="100%" CssClass="gvdatatable table table-striped table-bordered"
                            EmptyDataText="No records found" AllowPaging="true" AllowSorting="true" AutoGenerateColumns="false"
                            OnPageIndexChanging="gvAssociationUnlink_PageIndexChanging" PagerStyle-Font-Size="Large"
                            DataKeyNames="OwnerAssociationID">
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="OwnerAssociationID" HeaderText="Id" Visible="false"></asp:BoundField>
                                <asp:BoundField DataField="AssociationName" HeaderText="Association"/>
                                <%--<asp:BoundField DataField="Name" HeaderText="Owner " />--%>
                            </Columns>
                            <EmptyDataRowStyle Width="550px" ForeColor="Red" Font-Bold="true" />
                        </asp:GridView>
                    </div>
                ...
                <div class="form-group pull-left">
                    ...
                    <asp:Label ID="lblCheckUnlink" runat="server" Text="Please Select Atleast One Association!" ForeColor="Red" Visible="false"></asp:Label>
                </div>
                <span class="counter pull-left"></span>
<br /><br />
            </div>
