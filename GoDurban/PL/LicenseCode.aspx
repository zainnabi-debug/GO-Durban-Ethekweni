<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="LicenseCode.aspx.cs" Inherits="GoDurban.PL.LicenseCode" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
   ...
   <%-- <script src="../../Scripts1/buttons.html5.min.js"></script>--%>
    ...
    <h4>Create License Code </h4>
    <div id="accordion" role="tablist" aria-multiselectable="true">
        <div class="panel panel-default" style="width: 100%">
            <div class="panel-heading" role="tab" id="headingOne">
                <h4 class="panel-title">
                    <a id="first" data-toggle="collapse" data-parent="#accordion" href="#collapseOne" aria-expanded="false" aria-controls="collapseOne"><strong>
                        <asp:Label ID="Label2" runat="server" Text=" License Code "></asp:Label>
                    </strong>
                    </a>
                </h4>
            </div>
            ...
            <div id="collapseOne" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne" style="padding: 1%">
                ...
                <div class="row">
                    <div class="col-md-2">License Code:</div>
                    <div class="col-md-4">
                        <asp:TextBox ID="txtLicenseCode" placeholder="License Code" runat="server" class="form-control limited" Height="34px" Width="250px" onkeyup="CheckName(this);" onkeydown="CheckName(this);"></asp:TextBox>
                    </div>
                    <div class="col-md-2">License Code Description:</div>
                    <div class="col-md-4">
                        <asp:TextBox ID="txtLicenseCodeDescription" placeholder="License Code Description" runat="server" class="form-control limited" TextMode="MultiLine" Height="64px" Width="250px" onkeyup="CheckName(this);" onkeydown="CheckName(this);"></asp:TextBox>
                    </div>
                </div>
    ...
    <div id="accordion2" role="tablist" aria-multiselectable="true">
        <div class="panel panel-default">
            ...
            <div id="collapseTwo" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingTwo" style="padding: 1%">
                <div class="row">
                    <div class="col-md-12">
                        <asp:GridView ID="gvLicenseCode" Width="100%" CssClass="gvdatatable table table-striped table-bordered" 
                            runat="server" OnPreRender="gvLicenseCode_PreRender" AutoGenerateColumns="false" 
                            DataKeyNames="LicenseCodeID" OnRowCommand="gvLicenseCode_RowCommand">
                            ...
                            <Columns>
                              ...
                              <%--  <asp:TemplateField>
                                ...
                                <asp:BoundField DataField="LicenseCodeID" HeaderText="LicenseCodeID" SortExpression="Id" HeaderStyle-CssClass="hidden" ItemStyle-CssClass="hidden"></asp:BoundField>
                                <asp:BoundField DataField="LicenseCode" HeaderText="License Code" /> 
                                <asp:BoundField DataField="LicenseCodeDescription" HeaderText="Description"  />
                            </Columns>
                        </asp:GridView>
                    </div>
                </div>
