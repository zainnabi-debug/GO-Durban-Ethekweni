...
{
    public partial class ApproveVehicle : System.Web.UI.Page
    {
        ...
        {
            vehID = Convert.ToInt32(Request.QueryString["VehicleID"].ToString());
        ...
        public void LoadData()
        {
            ...
            gvVehicle.DataSource = list.ToList();
            gvVehicle.DataBind();
        }
        ...
        protected void btnAdd_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                else if (ValidateVehicleEdit() && temp.Contains("Update"))
                {
                    ...
                    var id = db.tbl_Vehicle.ToList().FirstOrDefault(x => x.VehicleID == vehID);
                    if ((v == null) || (id.NumberPlate == txtVehNoPlate.Text.Trim()))
                    {
                        if (ddlStatus.SelectedItem.Text == "Approved")
                        {
                            if (v.PaymentAdded == false || v.PaymentAdded == null)
                            {
                                TBL.PaymentAdded = true;
                            ...
                            divVehiclee.Style.Add("display", "inline");
                            divVehicleee.Style.Add("display", "inline");
                            ...
                            divUploadDocuments.Style.Add("display", "none");
                            divVehicle.Style.Add("display", "inline");
        ...
        {
            Response.Redirect("~/PL/ApproveVehicle.aspx?VehicleID=" + vehID);
        }
        ...
        public void SendSms()
        {
            try
            {
                if ((ddlOwner.SelectedValue != "0") && (ddlStatus.SelectedItem.Text == "Approved"))
                {
                    ...
                    req.Parameters.Parameter2.Value = txtVehNoPlate.Text;
        ...
        public void CreatePDF()
        {
            ...
            document.Add(new Paragraph("Approve Vehicle", titleFont));
            ...
            Response.AddHeader("Content-Disposition", "attachment; filename=ApproveVehicle.pdf");
        ...
        {
            var temp = db.tbl_Vehicle.ToList().FirstOrDefault(x => x.VehicleID == vehID);
            ...
            if (temp != null)
            {
                ...
                var data2 = db.tbl_Vehicle.ToList().FirstOrDefault(x => x.VehicleID == Convert.ToInt16(vehID));
