<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Account.aspx.cs" Inherits="GoDurban.PL.Account" %>
                ...
                <div class="row">
                    <div class="col-md-12">
                       ...
                       <asp:GridView ID="gvRegion" Width="100%" CssClass="gvdatatable table table-striped table-bordered"
                            ...
                            DataKeyNames="BankID" OnRowCommand="gvRegion_RowCommand">
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="BankID" HeaderText="RegionID" SortExpression="Id" HeaderStyle-CssClass="hidden" ItemStyle-CssClass="hidden"></asp:BoundField>
