<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AssociationServiceArea.aspx.cs" Inherits="GoDurban.PL.AssociationServiceArea" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
   ...
   <%-- <script src="../../Scripts1/buttons.html5.min.js"></script>--%>
    ...
    <h4>Link Association With Service Area</h4>
    <div id="accordion" role="tablist" aria-multiselectable="true">
        <div class="panel panel-default" style="width: 100%">
            <div class="panel-heading" role="tab" id="headingOne">
                <h4 class="panel-title">
                    <a id="first" data-toggle="collapse" data-parent="#accordion" href="#collapseOne" aria-expanded="false" aria-controls="collapseOne"><strong>
                        <asp:Label ID="Label2" runat="server" Text="">Association</asp:Label>
                    </strong>
                    </a>
                </h4>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="side-by-side clearfix">
                            <asp:DropDownList ID="ddlAssociation" runat="server" class="chosen-select" Width="300px" Height="34px" AppendDataBoundItems="True" AutoPostBack="true" OnSelectedIndexChanged="ddlAssociation_SelectedIndexChanged">
                    ...
                    <asp:Label ID="lblAssociation" runat="server" Text="Select Association!" ForeColor="Red" Visible="false"></asp:Label>
                        </div>
                    </div>
                </div>
    ...
    <div id="accordion2" role="tablist" aria-multiselectable="true" runat="server" style="display: none">
                    ...
                    <div class="col-md-12">
                        <asp:GridView ID="gvServiceAreaUnlink" runat="server" Width="100%" CssClass="gvdatatable table table-striped table-bordered"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="AssociationServiceAreaID" HeaderText="Id" Visible="false"></asp:BoundField>
