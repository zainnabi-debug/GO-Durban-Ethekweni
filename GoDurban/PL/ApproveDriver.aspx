<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ApproveDriver.aspx.cs" Inherits="GoDurban.PL.ApproveDriver" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <script type="text/javascript">
        ...
        $(function () {
            $("[id$=txtLicenseExpiry],[id$=txtPRDPExpiry],[id$=txtEmploymentContractExpiry]").datepicker({
                showOn: 'button',
    ...
    <div id="divDriverr" role="tablist" aria-multiselectable="true" runat="server" style="display: inline">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="side-by-side clearfix">
                            <asp:DropDownList ID="ddlOwner" runat="server" Enabled="false" CssClass="chosen-select" Width="250px" Height="34px" AutoPostBack="true" AppendDataBoundItems="True" onfocusout="ValidateOwner(this);" OnSelectedIndexChanged="ddlOwner_SelectedIndexChanged">
    ...
    <div id="divDriverrr" role="tablist" aria-multiselectable="true" runat="server" style="display: inline">
        <div class="panel panel-default" style="width: 100%">
            <div class="panel-heading" role="tab" id="headingOne">
                <h4 class="panel-title">
                    <a id="first" data-toggle="collapse" data-parent="#accordion" href="#collapseOne" aria-expanded="false" aria-controls="collapseOne"><strong>
            ...
            <div id="collapseOne" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne" style="padding: 1%">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <asp:TextBox ID="txtName" placeholder="Name" runat="server" Enabled="false" CssClass="form-control limited" MaxLength="100" Height="34px" Width="250px" onkeypress="return isSpaceKey(event)" onkeyup="CheckName(this); SetButtonStatus(this,'divShow'); " onkeydown="CheckName(this);" onfocusout="ValidateName(this);"></asp:TextBox>
                        <%--<asp:RequiredFieldValidator runat="server" ControlToValidate="txtName"
                            CssClass="text-danger" ErrorMessage="" />--%>
                    </div>
                    <div class="col-md-2">Surname: <span style="color: red">*</span></div>
                    <div class="col-md-4">
                        <asp:TextBox ID="txtSurname" placeholder="Surname" runat="server" Enabled="false" CssClass="form-control limited" MaxLength="100" Height="34px" Width="250px" onkeyup="CheckName(this); SetButtonStatus(this,'divShow'); " onkeydown="CheckName(this);" onfocusout="ValidateSurname(this);"></asp:TextBox>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <asp:TextBox ID="txtIDNo" placeholder="ID No." runat="server" Enabled="false" CssClass="form-control limited" Height="34px" Width="250px" onkeyup="SetButtonStatus(this,'divShow')" onkeypress="return isNumberKey(event)" onfocusout="ValidateIDNo(this);" MaxLength="13"></asp:TextBox>
                    ...
                    <div class="col-md-4">
                        <asp:TextBox ID="txtOfficeNo" placeholder="Office No." runat="server" Enabled="false" CssClass="form-control limited" Height="34px" Width="250px" onkeyup="SetButtonStatus(this,'divShow')" onkeypress="return isNumberKey(event)" onfocusout="ValidateOfficeNO(this);" MaxLength="10"></asp:TextBox>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-2">Cell No.: <span style="color: red">*</span></div>
                    <div class="col-md-4">
                        <asp:TextBox ID="txtCellNo" placeholder="Cell No." runat="server" Enabled="false" CssClass="form-control limited" Height="34px" Width="250px" onkeyup="SetButtonStatus(this,'divShow')" onkeypress="return isNumberKey(event)" onfocusout="ValidateCellNO(this);" MaxLength="10"></asp:TextBox>
                    ...
                    <div class="col-md-4">
                        <asp:DropDownList ID="ddlGender" runat="server" Enabled="false" AppendDataBoundItems="True" CssClass="form-control" Width="250px" Height="34px" onkeyup="SetButtonStatus(this,'divShow')" onfocusout="ValidateGender(this);">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <asp:TextBox ID="txtEmail" placeholder="Email" runat="server" Enabled="false" CssClass="form-control limited" MaxLength="50" Height="34px" Width="250px" onkeyup="ValidateEmailID(this);" onfocusout="ValidateBusinessEmail(this);"></asp:TextBox>
                    ...
                    <div class="col-md-4">
                        <asp:DropDownList ID="ddlRace" runat="server" Enabled="false" AppendDataBoundItems="True" CssClass="form-control" Width="250px" Height="34px" onkeyup="SetButtonStatus(this,'divShow')" onfocusout="ValidateRace(this);">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <asp:TextBox ID="txtLicenseExpiry" placeholder="License Expiry" runat="server" Enabled="false" CssClass="form-control limited" Height="34px" Width="250px" onkeyup="SetButtonStatus(this,'divShow')" onfocusout="ValidateLicenseExpiry(this);"></asp:TextBox>
                    ...
                    <div class="col-md-4">
                        <asp:DropDownList ID="ddlLicenseCode" runat="server" Enabled="false" AppendDataBoundItems="True" CssClass="form-control" Width="250px" Height="34px" onkeyup="SetButtonStatus(this,'divShow')" onfocusout="ValidateLicenseCode(this);">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <asp:TextBox ID="txtPRDPCode" placeholder="PRDP Code" runat="server" Enabled="false" CssClass="form-control limited" MaxLength="50" Height="34px" Width="250px" onkeyup="SetButtonStatus(this,'divShow')" onfocusout="ValidatePRDPCode(this);"></asp:TextBox>
                    ...
                    <div class="col-md-4">
                        <asp:TextBox ID="txtPRDPExpiry" placeholder="PRDP Expiry" runat="server" Enabled="false" CssClass="form-control limited" Height="34px" Width="250px" onkeyup="SetButtonStatus(this,'divShow')" onfocusout="ValidatePRDPExpiry(this);"></asp:TextBox>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <asp:TextBox ID="txtStreetNo" placeholder="Street No. & Name" runat="server" Enabled="false" CssClass="form-control limited" MaxLength="100" Height="34px" Width="250px" onkeyup="CheckName1(this); SetButtonStatus(this,'divShow')" onkeydown="CheckName1(this);" onfocusout="ValidateStreetNoName(this);"></asp:TextBox>
                    ...
                    <div class="col-md-4">
                        <asp:TextBox ID="txtSuburb" placeholder="Suburb" runat="server" Enabled="false" CssClass="form-control limited" MaxLength="50" Height="34px" Width="250px" onkeyup="CheckName(this); SetButtonStatus(this,'divShow')" onkeydown="CheckName(this);" onfocusout="ValidateSuburb(this);"></asp:TextBox>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <asp:TextBox ID="txtCity" placeholder="City" runat="server" Enabled="false" CssClass="form-control limited" MaxLength="50" Height="34px" Width="250px" onkeyup="CheckName(this); SetButtonStatus(this,'divShow')" onkeydown="CheckName(this);" onfocusout="ValidateCity(this);"></asp:TextBox>
                        <%--<asp:RequiredFieldValidator runat="server" ControlToValidate="txtCity"
                            CssClass="text-danger" ErrorMessage="" />--%>
                    </div>
                    <div class="col-md-2">Code: <span style="color: red">*</span></div>
                    <div class="col-md-4">
                        <asp:TextBox ID="txtCode" placeholder="Code" runat="server" Enabled="false" CssClass="form-control limited" Height="34px" Width="250px" onkeyup="SetButtonStatus(this,'divShow')" onkeypress="return isNumberKey(event)" MaxLength="4" onfocusout="ValidateCode(this);"></asp:TextBox>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <asp:DropDownList ID="ddlStatus" runat="server" AppendDataBoundItems="True" CssClass="form-control" Width="250px" Height="34px" onkeyup="SetButtonStatus(this,'divShow')" onfocusout="ValidateStatus(this);" AutoPostBack="true" OnSelectedIndexChanged="ddlStatus_SelectedIndexChanged">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <asp:RadioButtonList ID="rblEmploymentContract" runat="server" Enabled="false" onclick="onChangeApplication(this)" RepeatDirection="Horizontal" RepeatLayout="Flow" OnSelectedIndexChanged="rblEmploymentContract_SelectedIndexChanged">
                    ...
                    <div class="col-md-4">
                        <asp:TextBox ID="txtEmploymentContractExpiry" placeholder="Employment Contract Expiry" runat="server" Enabled="false" onkeyup="SetButtonStatus(this,'divShow')" CssClass="form-control limited" Height="34px" Width="250px" onfocusout="ValidateEmploymentContractExpiry(this);"></asp:TextBox>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <asp:FileUpload ID="fuRecommendationLetterScan" onchange="showButton2();ValidateSingleInputRec(this);ValidateSize2(this);" runat="server" Enabled="false" onfocusout="ValidateRecommendationLetterScan(this);" />
                    ...
                    <div class="col-md-4" id="divEmpContScan1" runat="server" style="display: none">
                        <asp:FileUpload ID="fuEmploymentContractScan" onchange="showButton1();ValidateSingleInputEmp(this);ValidateSize1(this);" runat="server" Enabled="false" onfocusout="ValidateEmploymentContractScan(this);" />
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <asp:FileUpload ID="fuDriverLicenseScan" onchange="showButton3();ValidateSingleInputDri(this);ValidateSize3(this);" runat="server" Enabled="false" onfocusout="ValidateDriverLicenseScan(this);" />
                    ...
                    <div class="col-md-4">
                        <asp:FileUpload ID="fuPRDPScan" onchange="showButton4();ValidateSingleInputPRD(this);ValidateSize4(this);" runat="server" Enabled="false" onfocusout="ValidatePRDPScan(this);" />
                ...
                <div class="row">
                    <div class="col-md-12">
                        <asp:CheckBox ID="chkTermsConditions" runat="server" Enabled="false" Width="40px" Height="40px" CssClass="ChkBoxClass form-control" onkeyup="SetButtonStatus(this,'divShow')" onfocusout="ValidateTermsConditions(this);" />
                ...
                <div class="row">
                    <div class="col-md-12">
                        <asp:CheckBox ID="chkReviewContract" runat="server" Enabled="false" Width="40px" Height="40px" CssClass="ChkBoxClass form-control" onkeyup="SetButtonStatus(this,'divShow')" onfocusout="ValidateReviewContract(this);" />
            ...
            <div class="panel-heading" role="tab" id="headingTwo">
                <h4 class="panel-title">
                    <a id="Second" data-toggle="collapse" data-parent="#accordion2" href="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo"><strong>
                        <asp:Label ID="lblAddb" runat="server" Text="Driver"></asp:Label>
                    </strong>
                    </a>
                </h4>
            </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <asp:GridView ID="gvDriver" runat="server" Width="100%" CssClass="gvdatatable table table-striped table-bordered"
                            ...
                            OnPreRender="gvDriver_PreRender" OnRowCommand="gvDriver_RowCommand">
                            <Columns>
                                <asp:TemplateField>
                                    <ItemTemplate>
                    ...
                    <div class="col-md-12">
                        ...
                        <asp:GridView ID="gvUpload" Width="100%" CssClass="gvdatatable table table-striped table-bordered"
                            ...
                            <Columns>
                                ...
                                <%--<asp:TemplateField>
                                    <ItemTemplate>
                                        <asp:LinkButton ID="lnkView" runat="server" Enabled="false" CssClass="btn btn-info" Text="View" CommandName="View">                                                
                                        </asp:LinkButton>
                                    </ItemTemplate>
                                    <ItemStyle Width="25px" />
                                </asp:TemplateField>--%>
