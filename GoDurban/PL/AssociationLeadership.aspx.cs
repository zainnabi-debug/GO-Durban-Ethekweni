...
{
    public partial class AssociationLeadership : System.Web.UI.Page
    {
        ...
        private void LoadData()
        {
            var list = (from a in db.tbl_AssociationLeadership
                        ...
                        where ((a.AssociationID == c.AssociationID) && c.StatusID == 15)
                    ...
                    {
                        {
                            ...
                            var id = db.tbl_AssociationLeadership.ToList().FirstOrDefault(x => x.AssociationLeaderID == Id);

                            var p = db.tbl_AssociationLeadership.ToList().Find(x => x.Passport == txtPassport.Text.ToString());

                            var pp = db.tbl_AssociationLeadership.ToList().FirstOrDefault(x => x.AssociationLeaderID == Id);
        ...
        public void CreatePDF()
        {
            ...
            document.Add(new Paragraph("Association Leadership", titleFont));
            ...
            Response.AddHeader("Content-Disposition", "attachment; filename=AssociationLeadership.pdf");
        ...
        protected void gvAssociationLeadership_RowDataBound(object sender, GridViewRowEventArgs e)
        {
