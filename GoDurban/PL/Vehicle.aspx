<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Vehicle.aspx.cs" Inherits="GoDurban.PL.Vehicle" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <script type="text/javascript">
        ...
        $(function () {
            $("[id$=txtVehOperatingLicenseExpiry]").datepicker({
                showOn: 'button',
                buttonImageOnly: true,
                startDate: new Date(),
                //format: 'dd-mm-yyyy',
    ...
    <h4>Create Vehicle And Link With Owner</h4>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="side-by-side clearfix">
                            <asp:DropDownList ID="ddlOwner" runat="server" class="chosen-select" Width="250px" Height="34px" AppendDataBoundItems="True" OnSelectedIndexChanged="ddlOwner_SelectedIndexChanged">
        ...
        <div class="panel panel-default" style="width: 100%">
            ...
            <div id="collapseOne" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne" style="padding: 1%">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="side-by-side clearfix">
                            <asp:DropDownList ID="ddlVehicleInfo" runat="server" AppendDataBoundItems="True" class="chosen-select" Width="250px" Height="34px" AutoPostBack="true" OnSelectedIndexChanged="ddlVehicleInfo_SelectedIndexChanged">
                    ...
                    <div class="col-md-4" id="divCapacity1" runat="server" style="display: none">
                        <asp:TextBox ID="txtCapacity" required="true" runat="server" CssClass="form-control" Width="70px" Height="34px" MaxLength="5" onkeypress="return isNumberKey(event)" onfocusout="ValidateCapacity(this);"></asp:TextBox>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <asp:TextBox ID="txtVehNoPlate" runat="server" PlaceHolder="Number Plate" CssClass="form-control" Width="250px" Height="34px" MaxLength="20" onkeyup="CheckName1(this);" onkeydown="CheckName1(this);" onfocusout="ValidateVehNoPlate(this);"></asp:TextBox>
                    </div>
                    <div class="col-md-2">Engine No.: <span style="color: red">*</span></div>
                    <div class="col-md-4">
                        <asp:TextBox ID="txtVehEngineNO" runat="server" PlaceHolder="Engine No." CssClass="form-control" Width="250px" MaxLength="50" Height="34px" onkeyup="CheckName1(this);" onkeydown="CheckName1(this);" onfocusout="ValidateVehEngineNO(this);"></asp:TextBox>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-2">Year Registered: <span style="color: red">*</span></div>
                    <div class="col-md-4">
                        <asp:DropDownList ID="ddlYearRegistered" runat="server" CssClass="form-control" Width="100px" Height="34px"></asp:DropDownList>
                    </div>
                    <div class="col-md-2">Last Service: <span style="color: red">*</span></div>
                    <div class="col-md-4">
                        <asp:TextBox ID="txtVehLastServiced" runat="server" PlaceHolder="Last Date Serviced" CssClass="form-control" Width="250px" Height="34px" onfocusout="ValidateLastServiced(this);"></asp:TextBox>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-2">Operating License: <span style="color: red">*</span></div>
                    <div class="col-md-4">
                        <asp:TextBox ID="txtOperatingLicense" runat="server" PlaceHolder="Operating License" CssClass="form-control" Width="250px" Height="34px" onkeyup="CheckName1(this);" onkeydown="CheckName1(this);" onfocusout="ValidateOperatingLicense(this);"></asp:TextBox>
                    </div>
                    <div class="col-md-2">OL Expiry: <span style="color: red">*</span></div>
                    <div class="col-md-4">
                        <asp:TextBox ID="txtVehOperatingLicenseExpiry" runat="server" PlaceHolder="Operating License Expiry" CssClass="form-control" Width="250px" Height="34px" onfocusout="ValidateOperatingLicenseExpiry(this);"></asp:TextBox>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <asp:TextBox ID="txtVehCORExpiry" runat="server" PlaceHolder="COR Expiry" CssClass="form-control" Width="250px" Height="34px" onfocusout="ValidateCORExpiry(this);"></asp:TextBox>
                    </div>
                    <div class="col-md-2">VIN No.: <span style="color: red">*</span></div>
                    <div class="col-md-4">
                        <asp:TextBox ID="txtVehVinNo" required="true" runat="server" PlaceHolder="VIN No." CssClass="form-control" MaxLength="50" Width="250px" Height="34px" onkeyup="CheckName1(this);" onkeydown="CheckName1(this);" onfocusout="ValidateVehVinNo(this);"></asp:TextBox>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <asp:FileUpload ID="fuCORScan" onchange="showButton1();ValidateSingleInput(this);ValidateSize(this);" runat="server" onfocusout="ValidateCORScan(this);" />
                ...
                <div class="row">
                    <div class="col-md-12">
                        <asp:GridView ID="gvVehicle" runat="server" Width="100%" CssClass="gvdatatable table table-striped table-bordered"
                            ...
                            OnPreRender="gvVehicle_PreRender" OnRowCommand="gvVehicle_RowCommand" OnRowDataBound="gvVehicle_RowDataBound">
                            <Columns>
                                <asp:TemplateField>
                                    <ItemTemplate>
                    ...
                    <div class="col-md-12">
                        ...
                        <asp:GridView ID="gvUploadVehicle" Width="100%" CssClass="gvdatatable table table-striped table-bordered"
                            ...
                            <Columns>
                                ...
                                <%--  <asp:BoundField DataField="Link_URL"  HeaderText="Link URL"  />--%>
                                ...
                                <%-- <asp:TemplateField>
                                    <ItemTemplate>
                                        <asp:LinkButton DataField="Link_URL" ID="lnkView" runat="server" CssClass="btn btn-info" Text="View" CommandName="View">
